...
QIcon SeafileTrayIcon::stateToIcon(TrayState state)
{
    ...
    case STATE_DAEMON_AUTOSYNC_DISABLED:
        return QIcon(":/images/mac/wingufile_auto_sync_disabled.png");
    case STATE_TRANSFER_1:
        return QIcon(":/images/mac/wingufile_transfer_1.png");
    case STATE_TRANSFER_2:
        return QIcon(":/images/mac/wingufile_transfer_2.png");
    }
#else
    switch (state) {
    case STATE_DAEMON_UP:
    ...
    case STATE_DAEMON_AUTOSYNC_DISABLED:
        return QIcon(":/images/wingufile_auto_sync_disabled.png");
    case STATE_TRANSFER_1:
        return QIcon(":/images/wingufile_transfer_1.png");
    case STATE_TRANSFER_2:
        return QIcon(":/images/wingufile_transfer_2.png");
    }
#endif
}
