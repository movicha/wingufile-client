...
const char *kSeafileRpcService = "wingufile-rpcserver";
...
void SeafileRpcClient::connectDaemon()
{
    ...
    wingufile_rpc_client_ = ccnet_create_async_rpc_client(async_client_, NULL, kSeafileRpcService);
